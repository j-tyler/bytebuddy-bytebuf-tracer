...
public class ByteBufFlowTrackerTest {
    ...
    public static class StaticMethodExample {
        ...
        public void processWithInstance(ByteBuf buffer) {
            ByteBufFlowTracker.getInstance().recordMethodCall(
                buffer, getClass().getSimpleName(), "processWithInstance",
                getClass().getSimpleName() + ".processWithInstance", buffer.refCnt());
        }
    ...
    public static class ProductionExample {
        ...
        public void handleMessage(ByteBuf message) {
            ...
            tracker.recordMethodCall(message, getClass().getSimpleName(), "handleMessage",
                getClass().getSimpleName() + ".handleMessage", message.refCnt());
            ...
            try {
                ...
                message.release();
                tracker.recordMethodCall(message, getClass().getSimpleName(), "handleMessage_exit",
                    getClass().getSimpleName() + ".handleMessage_exit", message.refCnt());
            }
        }

        private void processInternal(ByteBuf message) {
            tracker.recordMethodCall(message, getClass().getSimpleName(), "processInternal",
                getClass().getSimpleName() + ".processInternal", message.refCnt());
            // ... actual processing ...
        }
    }
