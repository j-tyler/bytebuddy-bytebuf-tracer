...
public class DirectBufferLeakHighlightingTest {
    ...
    public void testProperlyReleasedBuffersShowNoLeakEmoji() {
        ...
        heapBuf.release();
        tracker.recordMethodCall(heapBuf, "UnpooledHeapByteBuf", "release", "UnpooledHeapByteBuf.release", 0);

        ByteBuf directBuf = allocator.directBuffer(256);
        tracker.recordMethodCall(directBuf, "UnpooledByteBufAllocator", "directBuffer", "UnpooledByteBufAllocator.directBuffer", directBuf.refCnt());
        tracker.recordMethodCall(directBuf, "GoodService", "send", "GoodService.send", directBuf.refCnt());
        directBuf.release();
        tracker.recordMethodCall(directBuf, "UnpooledDirectByteBuf", "release", "UnpooledDirectByteBuf.release", 0);
    ...
    public void testRealWorldTriageScenario() {
        ...
        tracker.recordMethodCall(goodDirectBuf, "UnpooledDirectByteBuf", "release", "UnpooledDirectByteBuf.release", 0);
