...
public class WeakActiveTrackerTest {
    ...
    public void testGetOrCreate_CreatesNewFlow() {
        ...
        WeakActiveFlow flow = tracker.getOrCreate(obj, "TestClass", "testMethod", "TestClass.testMethod");
    ...
    public void testGetOrCreate_ReturnsSameFlowForSameObject() {
        Object obj = new Object();
        WeakActiveFlow flow1 = tracker.getOrCreate(obj, "TestClass", "testMethod", "TestClass.testMethod");
        WeakActiveFlow flow2 = tracker.getOrCreate(obj, "TestClass", "testMethod", "TestClass.testMethod");
    ...
    public void testMarkRemainingAsLeaks_MarksAllActiveFlows() {
        ...
        tracker.getOrCreate(obj1, "TestClass", "method1", "TestClass.method1");
        tracker.getOrCreate(obj2, "TestClass", "method2", "TestClass.method2");
    ...
    public void testStatistics_TotalObjectsSeen() {
        tracker.getOrCreate(new Object(), "TestClass", "method1", "TestClass.method1");
        tracker.getOrCreate(new Object(), "TestClass", "method2", "TestClass.method2");
        tracker.getOrCreate(new Object(), "TestClass", "method3", "TestClass.method3");
    ...
    public void testGCDetection_LeakDetectedWhenObjectIsGCd() throws InterruptedException {
        Object obj = new Object();
        tracker.getOrCreate(obj, "TestClass", "testMethod", "TestClass.testMethod");
    ...
    public void testLazyGCProcessing_ProcessesEvery100Calls() throws InterruptedException {
        ...
        for (int i = 0; i < 99; i++) {
            ...
            tracker.getOrCreate(new Object(), "TestClass", methodName, "TestClass." + methodName);
        }
        ...
        tracker.getOrCreate(new Object(), "TestClass", "method100", "TestClass.method100");
    ...
    public void testFirstCallOnNewThread_ProcessesImmediately() throws Exception {
        ...
        Thread newThread = new Thread(() -> {
            ...
            tracker.getOrCreate(new Object(), "TestClass", "newThreadMethod", "TestClass.newThreadMethod");
        });
